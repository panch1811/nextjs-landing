        ...
        <div className={styles.container}>
            <div className={styles.imgContainer}>
                ...
                <div className={styles.imgText}>
                    <h1 className={styles.imgTitle}>Stellarsoft</h1>
                    <h2 className={styles.imgDesc}>Designed to Make You Grow Fast</h2>
                </div>
            </div>
            <div className={styles.textContainer}>
                ...
                <div className={styles.item}>
                    ...
                    <p className={styles.desc}>
                        ...
                        Hydrogen apps
                        <br />
                        <br /> - Shopify web sites
                        <br />
                        <br /> - Shopify apps
                        <br />
                        <br /> - Shopify Hydrogen projects
                    </p>
